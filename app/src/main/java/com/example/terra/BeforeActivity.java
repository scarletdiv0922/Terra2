...
//                            .child(cmd.substring(i, j)).removeValue();
                    ...
                    if (cmd.substring(i, j).equals("earthquake") || cmd.substring(i, j).equals("earthquakes")) {
                        Intent intent = new Intent(BeforeActivity.this, BeforeActivity.class);
                    ...
                    int j = cmd.indexOf("\"}");
                    if (cmd.substring(i, j).equals("earthquake") || cmd.substring(i, j).equals("earthquakes")){
                        Intent intent = new Intent(BeforeActivity.this, DuringActivity.class);
                        intent.putExtra("Disaster", "Earthquakes");
                        startActivity(intent);
                    }
                    else if (cmd.substring(i, j).equals("wildfire") || cmd.substring(i, j).equals("wildfires")){
                    ...
                    int j = cmd.indexOf("\"}");
                    if (cmd.substring(i, j).equals("earthquake") || cmd.substring(i, j).equals("earthquakes")) {
                        Intent intent = new Intent(BeforeActivity.this, DisasterMapActivity.class);
                        intent.putExtra("Disaster", "Earthquakes");
                        startActivity(intent);
                    }
                    else if (cmd.substring(i, j).equals("wildfire") ||cmd.substring(i, j).equals("wildfires")){
                    ...
                    //TODO
                    Toast.makeText(BeforeActivity.this, "near", Toast.LENGTH_SHORT).show();
                }
                    ...
                    if (cmd.substring(i, j).equals("home")){
                        Intent intent = new Intent(BeforeActivity.this, HomeScreenActivity.class);
                        startActivity(intent);
                    }
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BeforeActivity.this, BDAActivity.class);
